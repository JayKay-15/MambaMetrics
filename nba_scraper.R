...
sched <- nbastatR::game_logs(seasons = 2023, result_types = "team", season_types = "Regular Season") %>% select(5) %>% distinct()
...
openxlsx::write.xlsx(df, file = "/Users/Jesse/Desktop/rebounding.xlsx")
...
openxlsx::write.xlsx(dt, file = "/Users/Jesse/Desktop/isolation_off.xlsx")
