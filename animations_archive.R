...
player_id <- find_player_id_by_name("lebron james")
df <- fetch_shots_by_player_id_and_season(player_id, "2022-23", "Regular Season")
df <- df$player
df_filtered <- subset(df, df$shot_zone_basic != "Restricted Area")

generate_heatmap_chart(df_filtered, plot_court())
