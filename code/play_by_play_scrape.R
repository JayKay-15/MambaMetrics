...
#### play by play ----
scrape_nba_play_by_play <- function(game_id = "0022200334") {
...
pbp <- scrape_nba_play_by_play(game_id = "0022300367")


#### win probability ----
scrape_nba_win_probability <- function(game_id = "0022200334") {
...
win_prob <- scrape_nba_win_probability(game_id = "0022300367")
